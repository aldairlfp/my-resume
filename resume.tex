...
\begin{cventries}
  \cventry
    ...
    {Jan 2026 - Apr 2026}
    {\begin{cvitems}
      \item Developing and maintaining backend modules in an \textbf{ABP-based ASP.NET} platform, improving reliability of core business workflows.
      \item Building and refining endpoints with \textbf{Minimal APIs in .NET 8}, implementing clean request/response contracts and maintainable feature organization.
      \item Implementing full-stack capabilities across \textbf{Angular frontend and .NET backend}, from UI flows to API integration.
      \item Delivering end-to-end features across legacy and modern codebases, collaborating with the team to improve consistency and maintainability.
        \end{cvitems}}
  ...
  \cventry
    ...
    {\begin{cvitems}
        ...
        \item Developed several \textbf{web scraping tools} using Python to extract and process data from multiple sources efficiently.
        \end{cvitems}}
  ...
  \cventry
    ...
    {Dec 2022 - Sep 2024}
    {\begin{cvitems}
        \item Delivered backend services across multiple independent projects using \textbf{Go}, \textbf{FastAPI}, and \textbf{ASP.NET}, adapting architecture and tooling to each client's needs.
        \item Designed and documented \textbf{RESTful APIs} following clean architecture principles, improving maintainability and reducing integration friction for client teams.
        \item Built \textbf{React} frontends consuming custom-built APIs, owning the full delivery cycle from backend logic to UI across diverse client projects.
        \item Applied database design best practices with \textbf{PostgreSQL} and \textbf{MySQL}, optimizing queries and schema structure to support reliable, performant data access.
        \end{cvitems}}
